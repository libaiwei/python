...
def extract_data(filenames):
    ...
    for f in filenames:
        ...
        print type(bytestream),bytestream
...
class Cifar10DataSet(object):
    ...
    def __init__(self,data_dir):
        ...
        self.train_labels,self.train_images = extract_train_data(os.path.join(data_dir,'cifar10_data/cifar-10-batches-bin'))
        self.test_labels,self.test_images = extract_test_data(os.path.join(data_dir,'cifar10_data/cifar-10-batches-bin'))
